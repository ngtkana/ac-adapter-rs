...
//! # TODO
//!
//! modint::Mint とは別 crate なのですが、本当は協調動作をしていただきたいです。
//! 具体的には、[`Zero`] トレイトを modint::Mint 型に実装したいです。
//!
//! 将来的には、num_traits に相当するものを実装してそれに依存する可能性が高いです。
//! それはあまり難しいことではないのですが、ライブラリ間の依存は、
//! コンテストのことを考えると少し躊躇してしまいます。
//!
//! 適切な budnle ツールを作れるまで待つか、
//! 待たずにまずはコピペで対処するのかは悩むところです。
//!
//! そもそもコメントとテストを消す bundle は作りたいんですよね……
//!
//! # TODO
//!
//! Entry を使うときれいにかけるか検証したいです。
//!
